    ...
    public WeatherResponse getWeatherByLocation(String location) {
        ...
        List<ForecastWeather> forecast = Arrays.asList(
                ...
                ForecastWeather.builder()
                        ...
                        .minTemperature(25.0)
                        .maxTemperature(30.6)
                        .weatherDescription("Expect very hot and muggy conditions on July 11, 2025, with apparent temperatures reaching up to 37.8°C due to high humidity. The day will see a mix of clear and cloudy skies, alongside a chance of moderate rainfall. Be aware of a very high UV index throughout the day.")
                        .icon("cloudy")
                        .build(),
                ForecastWeather.builder()
